...
if(RTNEURAL_EIGEN)
    ...
    target_compile_definitions(RTNeural INTERFACE RTNEURAL_USE_EIGEN=1)
    target_include_directories(RTNeural INTERFACE modules/Eigen)
elseif(RTNEURAL_XSIMD)
    message(STATUS "RTNeural -- Using xsimd backend")
    target_compile_definitions(RTNeural INTERFACE RTNEURAL_USE_XSIMD=1)
    target_include_directories(RTNeural INTERFACE modules/xsimd/include)
elseif(RTNEURAL_STL)
